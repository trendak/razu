...
$.DateTimePicker = $.DateTimePicker || {
	...
	defaults:  //Plugin Defaults
	{
		...
		shortDayNames: ["Niedz", "Pn", "Wt", "Śr", "Czw", "Pt", "Sob"],
		...
		showHeader: true,
		titleContentDate: "Data urodzenia",
		...
		_modifyPicker: function()
		{
			...
			for(iTempIndex = 0; iTempIndex < iNumberOfColumns; iTempIndex++)
			{
				...
				if(oDTP.settings.readonlyInputs)
					sDTPickerComp += "<input type='number' class='dtpicker-compValue' readonly>";
				else
					sDTPickerComp += "<input type='number' class='dtpicker-compValue'>";
